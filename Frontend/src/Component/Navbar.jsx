...
import { FaUserCircle } from "react-icons/fa"; // استخدام أيقونة المستخدم من مكتبة react-icons
...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    if (authStatus && storedUserName) {
      ...
      setUserName(storedUserName); // قراءة اسم المستخدم من localStorage
    }
  }, []);
  ...
  const handelLogout = async () => {
    try {
      ...
      setUserName(""); // تفريغ اسم المستخدم بعد الخروج
      navigate("/signin");
    } catch (error) {
